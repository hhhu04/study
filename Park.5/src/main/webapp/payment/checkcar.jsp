...
<input type="button" id="add" value="카드"><input type="button" id="add2" value="현금"><input type="button" id ="main" value="홈">
<br>
</form>
 ...
 $('#add').on('click', function(e) {
 	...
 	$.ajax({
        	...
        	success : function(data){
        			...
        			else if($.trim(data) == "carNum") alert("차량번호 틀림");
	 ...
	 $('#add2').on('click', function(e) {
	 	...
	 	$.ajax({
	        	...
	        	success : function(data){
	        			...
	        			else if($.trim(data) == "999") alert("차량번호 입력");
	        			else $(location).attr('href','/Park/payment/money.jsp');	
	        	},
	        		error:function(data){
	        			console.log(data);
	        	}
