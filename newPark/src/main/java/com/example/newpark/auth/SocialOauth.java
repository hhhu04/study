...
public interface SocialOauth {
    ...
    default com.example.newpark.auth.SocialLoginType type() {
        if (this instanceof GoogleOauth) {
            return com.example.newpark.auth.SocialLoginType.GOOGLE;
        } else if (this instanceof com.example.newpark.auth.KakaoOauth) {
            return com.example.newpark.auth.SocialLoginType.KAKAO;
        } else {
            return null;
        }
    }
