 ...
 $('#2').on('click', function(e) {
 	...
 	$.ajax({
        	...
        	success : function(data){
				...
				$list = $('ul');
				$list.append('<li>' +'<a href="/Park/store/storejoin.jsp"<button id="adder" class="btn btn-primary" >가맹점 추가</button></a> &#09; <a href="/Park/store/storejoin.jsp"<button id="adder" class="btn btn-primary" >가맹점 제거</button></a>'+ '</li>');
        	},
        		error:function(data){
        			console.log(data);
        	}
