...
<input type="text" id="dis" name="dis" placeholder="할인금액">
<input type="text" id="day" name="day" placeholder="개약기간">
<input type="button" class="btn btn-primary" id="add" value="등록">
